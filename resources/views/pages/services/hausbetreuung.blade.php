...
@section('og_image', '/assets/mirror/eco-clean.at/wp-content/uploads/2024/11/19.png')
...
<div data-rocket-location-hash="8c794ddef2d69cf9349ef0cbf14d7792" data-elementor-type="wp-page" data-elementor-id="1748" class="elementor elementor-1748" data-elementor-post-type="page">
	...
	<path class="elementor-shape-fill" d="M0,6V0h1000v100L0,6z"/>
		...
		<div class="elementor-element elementor-element-8411a4a e-con-full e-flex e-con e-child" data-id="8411a4a" data-element_type="container" data-e-type="container">
				...
				<div class="elementor-widget-container">
															<img decoding="async" width="530" height="562" src="{{ asset('assets/mirror/eco-clean.at/wp-content/uploads/2024/11/19-530x562.png') }}" class="attachment-large size-large wp-image-1732" alt="" />															</div>
				</div>
				</div>
					</div>
				</div>
		...
		<div class="elementor-element elementor-element-db75afa e-con-full e-flex e-con e-child" data-id="db75afa" data-element_type="container" data-e-type="container">
				...
				<div class="elementor-widget-container">
															<img loading="lazy" decoding="async" width="530" height="570" src="{{ asset('assets/mirror/eco-clean.at/wp-content/uploads/2024/11/18.png') }}" class="attachment-full size-full wp-image-1731" alt="" />															</div>
				</div>
				</div>
		...
		<div class="elementor-element elementor-element-c1c38a9 e-con-full e-flex e-con e-child" data-id="c1c38a9" data-element_type="container" data-e-type="container">
				...
				<div class="elementor-widget-container">
															<img loading="lazy" decoding="async" width="530" height="562" src="{{ asset('assets/mirror/eco-clean.at/wp-content/uploads/2024/11/20-530x562.png') }}" class="attachment-large size-large wp-image-1733" alt="" />															</div>
				</div>
				</div>
					</div>
				</div>
